...
//    }
//    Authorization
//    Bearer a2cf825fb9064f67ff1f5b45f838b3dd1e670dbfc100c547d91085f146fbc04e
//    dönüşte 201
//    id extract
    ...
    public void setup(){
        ...
        reqSpec = new RequestSpecBuilder()
                .addHeader("Authorization","Bearer a2cf825fb9064f67ff1f5b45f838b3dd1e670dbfc100c547d91085f146fbc04e")
                .setContentType(ContentType.JSON)
                .build();
    }


    @Test(enabled = false)                                     // ********************************* Zor YÖNTEM ************************************
    public void createUserJSon(){
        ...
        userID=
                given() // giden body, token, contentType
                        .header("Authorization","Bearer a2cf825fb9064f67ff1f5b45f838b3dd1e670dbfc100c547d91085f146fbc04e")
    ...
    @Test
    public void createUserMAP(){                                       // ********************************* EN KOLAY YÖNTEM ************************************
